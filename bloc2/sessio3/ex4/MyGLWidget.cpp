...
void MyGLWidget::resizeGL (int w, int h)
{
    ...
    if (rViewport < 1.0) {
        top = radi / rViewport;
        bottom = - radi / rViewport;
        left = - radi;
        right = radi;
    }
    else {
        left = - radi * rViewport;
        right = radi * rViewport;
        top = radi;
        bottom = - radi;
    }
...
void MyGLWidget::carregaShaders()
{
  ...
  fs.compileSourceFile("/Users/florenciarimolo/Dropbox/uni/idi/lab/bloc2/sessio3/ex4/shaders/fragshad.frag");
  vs.compileSourceFile("/Users/florenciarimolo/Dropbox/uni/idi/lab/bloc2/sessio3/ex4/shaders/vertshad.vert");
  // Creem el program
...
void MyGLWidget::iniCamera()
{
    ...
    znear = d - radi;
    zfar  = d + radi;
    lefti = left = bottom = bottomi = -radi;
    right = righti = top = topi = radi;
    ra    = 1.0;
    angle = 0.0;

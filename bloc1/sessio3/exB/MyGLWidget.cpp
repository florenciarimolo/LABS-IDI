...
void MyGLWidget::initializeGL ()
{
  ...
  ex = ey = ez = 1.0;  // ez? Si el model es 2D!
  glClearColor (0.5, 0.7, 1.0, 1.0); // defineix color de fons (d'esborrat)
  carregaShaders();
  createBuffers();
  transformaModel();   // transformacio inicial
}
...
void MyGLWidget::carregaShaders()
{
  ...
  fs.compileSourceFile("/Users/florenciarimolo/Dropbox/uni/idi/lab/bloc1/sessio3/exB/shaders/fragshad.frag");
  vs.compileSourceFile("/Users/florenciarimolo/Dropbox/uni/idi/lab/bloc1/sessio3/exB/shaders/vertshad.vert");
  // Creem el program

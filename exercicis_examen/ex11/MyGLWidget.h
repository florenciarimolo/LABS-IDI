...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  protected:
    ...
    void focusCam(bool checked);
    void focusEsc(bool checked);
  ...
  private:
    ...
    // attribute locations
    GLuint vertexLoc, normalLoc, matambLoc, matdiffLoc, matspecLoc, matshinLoc,  pintaVacaLoc, canviFrangesLoc, focusEscenaLoc;

...
QT_MOC_LITERAL(3, 24, 4), // "zoom"
QT_MOC_LITERAL(4, 29, 8), // "focusCam"
QT_MOC_LITERAL(5, 38, 7), // "checked"
QT_MOC_LITERAL(6, 46, 8), // "focusEsc"
QT_MOC_LITERAL(7, 55, 7), // "setZoom"
QT_MOC_LITERAL(8, 63, 11), // "setFocusCam"
QT_MOC_LITERAL(9, 75, 11) // "setFocusEsc"

    },
    "MyGLWidget\0zoomChanged\0\0zoom\0focusCam\0"
    "checked\0focusEsc\0setZoom\0setFocusCam\0"
    "setFocusEsc"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->focusCam((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->focusEsc((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->setZoom((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->setFocusCam(); break;
        case 5: _t->setFocusEsc(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::zoomChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::focusCam)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MyGLWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::focusEsc)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void MyGLWidget::focusCam(bool _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void MyGLWidget::focusEsc(bool _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };

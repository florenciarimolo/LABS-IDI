...
void MyGLWidget::createBuffers ()
{
  ...
  patr.load("/Users/florenciarimolo/Dropbox/uni/idi/lab/exercicis_examen/ex1/models/Patricio.obj");
...
void MyGLWidget::carregaShaders()
{
  ...
  fs.compileSourceFile("/Users/florenciarimolo/Dropbox/uni/idi/lab/exercicis_examen/ex1/shaders/fragshad.frag");
  vs.compileSourceFile("/Users/florenciarimolo/Dropbox/uni/idi/lab/exercicis_examen/ex1/shaders/vertshad.vert");
  // Creem el program
...
void MyGLWidget::iniCamera()
{
    ...
    obs = glm::vec3(0.0, 0.0, 1.5 * radiEsc);
